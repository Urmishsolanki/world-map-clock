                        ...
                        <div class="card bg-pattern shadow-none">
                            <div class="card-body reset-password-link" >
                                <div class="p-3">
                                    ...
                                    <?php endif; ?>
                                    <form class="form-horizontal" method="POST" action="<?php echo e(route('ResetPasswordPost')); ?>">
                                        <?php echo csrf_field(); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="email" type="text" class="form-control" name="email" placeholder="Enter e-mail address" value="<?php echo e($email); ?>" autofocus>
                                        ...
                                        <div class="mt-3">
                                            <button class="btn btn-primary btn-block waves-effect waves-light" type="submit"><?php echo e(__('Reset Password')); ?></button>
                                        </div>
                                    </form>
                                </div>
                            </div>
...
</html><?php /**PATH /home3/cyblasjd/wixwebsitesbuilder.com/world-map-clock/resources/views/auth/forget-password-link.blade.php ENDPATH**/ ?>