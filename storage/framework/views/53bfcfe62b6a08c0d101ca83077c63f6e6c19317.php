      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-body">
            <div style="float: right;"><img src="<?php echo e(URL::asset('public/img/pop-up-close.png')); ?>" class="close_id"></div>
            <form class="form-horizontal row g-3" method="post" id="searchFrom" name="worldMapClockAddForm">
              ...
              <div class="col-md-12 placeSearch">
                ...
                <span id="name-error" class="text-danger"><?php echo e($errors->first('name')); ?></span>
              </div> <br>
...
<script type="text/javascript">
  ...
  $('body').on('click', '.editProduct', function() {
    ...
    $('#modelHeading').html("");
    $.get("<?php echo e(route('city.index')); ?>" + '/' + city_id + '/edit', function(data) {
  ...
  jQuery('body').on('click', '#delete-city', function() {
    ...
    var url = "<?php echo e(route('city.destroy',':id')); ?>";
  ...
  $('#new').click(function(e) {
    $.ajax({
      url: "<?php echo e(route('city.create')); ?>",
      type: "GET",
      dataType: 'json',
    });
  });
  ...
  $(document).ready(function() {
    var url = "<?php echo e(url('get-city')); ?>";
    $("#city_name").keyup(function() {
...
<?php echo $__env->make('admin.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/cyblasjd/wixwebsitesbuilder.com/world-map-clock/resources/views/admin/index.blade.php ENDPATH**/ ?>