...
<head>
  ...
  <script src="https://maps.googleapis.com/maps/api/js?key=Add Your key"></script>
</head>
...
<body>
  ...
  <div class="ei-logo-img"><a href="https://www.ei-ie.org/en" target="_blank"><img src="{{url('public/img/logo.png')}}" height="60px"></a></div>
  <div class="ei-setting-img"><a href="{{url('/login')}}"><img src="{{url('public/img/setting.png')}}" height="25px"></a></div>
